<x-app-layout>
    ...
    <script>
        /*TITLE Y IMG*/
        gsap.from('.home__title', {opacity: -1, duration: 1.5, delay:0.5})
        gsap.from('.home__img', {opacity: 0, duration: 1, delay:0.5, x: 100})
        gsap.from('.home__information', {opacity: 0, duration: 1, delay:0.5, y: -30})

        /*BOX*/
        gsap.from('.box__medium', {opacity: 0, duration: 1.5, delay:0.8, y: -50})
        gsap.from('.box__small', {opacity: -1, duration: 1.5, delay:0.9, y: -50})
    </script>
